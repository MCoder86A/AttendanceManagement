        ...
        <div class="row">
            <div class="container">
                <div class="textBox">
                    ...
                    <div class="intro">Claim your presence in just one click
                        Get attendance performance right into your fingertips
                    </div>
                </div>
            </div>
                ...
                <div class="master_img">
                    <form action="#" name="loginForm" class="teacherform" onsubmit="return onSub()">
                        ...
                        <div class="refer_user">
                            Are you a Teacher? &nbsp<a href="../../master/login">click here</a> 
                        </div>
                    </form>
                </div>
            </div>
