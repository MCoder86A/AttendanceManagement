...
<body>
    ...
    <div class="section_a">
        <div class="row">
            <div class="container">
                <div class="textBox">
                    <div class="c_name">Regify</div>
                    <div class="intro">IT HELPS MANAGE STUDENT'S REGISTRY
                    </div>
                </div>
                <div class="butn">
            ...
            <div class="container_b" id="container_b_id">
                <div class="master_img">
                    <img id="t_img" src="https://nulphary.sirv.com/Images/master.png">
                    <img id="d_img" src="https://nulphary.sirv.com/Images/mastertab.png">
                </div>
            </div>
        </div>
